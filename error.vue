<template>
  <div
    class="min-h-screen bg-gradient-to-r from-primary-600 to-pink-600 flex items-center justify-center px-4"
  >
    <div class="max-w-lg w-full bg-white rounded-lg shadow-xl p-8 text-center">
      <div class="mb-8">
        <div class="animate-bounce">
          <svg
            class="w-24 h-24 mx-auto text-primary-600"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
      ...
      <div class="space-x-4">
        ...
        <NuxtLink
          to="/"
          class="bg-gray-200 text-gray-800 px-6 py-3 rounded-lg hover:bg-gray-300 transition-colors duration-200 inline-block"
        >
          Return Home
        </NuxtLink>
      </div>
