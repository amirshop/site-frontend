<template>
  ...
  <nav
    v-if="false"
    class="bg-primary"
    :class="{ 'relative z-50 shadow-lg': route.name !== 'contact' }"
  >
    <UContainer
      :ui="{
    ...
    >
      <div class="flex items-center justify-between h-16">
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              <NuxtLink
                to="/"
                class="text-white hover:bg-primary-500 hover:text-white px-3 py-2 rounded-md text-sm font-medium transition-colors duration-200"
              >
                Home
              </NuxtLink>
              <NuxtLink
        ...
        <div class="flex items-center space-x-4">
          ...
          <NuxtLink
            to="/auth/register"
            class="bg-primary-800 text-white hover:bg-primary-700 px-4 py-2 rounded-md text-sm font-medium transition-colors duration-200"
          >
            Register
          </NuxtLink>
          <UTooltip :text="colorMode.preference">
            <UButton type="primary" @click="toggleColorModes">
              <ClientOnly>
