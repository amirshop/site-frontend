<template>
  <section class="bg-gray-50 dark:bg-gray-900 py-16">
    ...
    <div class="container mx-auto px-4 mb-12">
      <h1
        class="text-4xl md:text-5xl font-bold text-center text-gray-900 dark:text-gray-300 mb-4"
      >
        Our Collection
      </h1>
      <p
        class="text-xl text-gray-600 dark:text-gray-300 text-center max-w-2xl mx-auto"
      >
          ...
          >
            ...
            <div class="p-6">
              <div class="flex justify-between items-start mb-4">
                ...
                <span
                  class="bg-primary-100 text-primary-800 text-sm font-medium px-2.5 py-0.5 rounded-full"
                >
                  New
                </span>
              </div>
              ...
              <div class="flex justify-between items-center">
                ...
                <NuxtLink
                  class="bg-primary-600 text-white px-4 py-2 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity"
                  :to="{
                    name: 'products-slug',
...
const { data: products } = await useFetch<ProductInterface[]>(
  "http://localhost:5500/api/v2/products"
);
</script>
